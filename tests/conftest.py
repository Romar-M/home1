...
def sample_operations():
    ...
    return [
        {"state": "EXECUTED", "date": "2024-03-14T10:30:00", "id": 1, "description": "Перевод организации", "amount": 1000},
        ...
        {"state": "EXECUTED", "date": "2024-03-10T08:00:00", "id": 5, "description": "Пополнение счета", "amount": 3000},
    ]
